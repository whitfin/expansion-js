Object.defineProperties(Object.prototype, {
    ...
    /**
     * A quick way to create a path inside an object without the need
     * to check for existence in advance. Allows a key, or a dot-noted
     * path to use to traverse through the object.
     *
     * @param path              a key, or a dot-noted key path
     * @param value             the final value of the path
     * @return this             the modified object
     */
    createKey:{
        enumerable:false,
        value:function(path, value){
            if(path == undefined || value == undefined || path.instance() != "String"){
                return this;
            }
            var keys = path.asKeys();
